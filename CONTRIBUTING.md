# Contributing to the Jworks 360 tool

As a Jworks citizen we would for you to contribute to the 360 tool and help to make it even better!
...
[submitting an issue](#submit-issue) to our [GitHub Repository][github]. Screenshots are also helpful.

You can help even more by [submittin a Pull Request](#submit-pr) with a fix.
...
You can file new issues by providing the above information [here](https://github.com/Ordineo/front-end/issues/new).

### <a name="submit-pr"></a> Submitting a Pull Request (PR)
Before you submit your Pull Request (PR) consider the following guidelines:

* Search [GitHub](https://github.com/Ordineo/front-end/pulls/new) for an open or closed PR
